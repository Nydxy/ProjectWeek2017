...
enum  QuestionType { Completion, Choice, TrueFalse }; //题目类型
...
public:
	...
	Question() {}
	Question(QuestionOption questionOption, QuestionType questionType = Completion)
	{
		Options = questionOption;
		Type = questionType;
	}
	bool CheckAnswerValidity(float a) //判断答案是否符合难度要求
	{
